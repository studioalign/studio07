		...
		return (
			<div className="space-y-8">
				<div className="flex justify-between items-center">
					<h1 className="text-2xl font-bold text-brand-primary mb-0">
						Dashboard
					</h1>
					<button
						disabled
			...
			<div className="space-y-8">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
					<StatsCard
						...
						icon={DollarSign}
						trend={`${ownerData.revenue.percentChange >= 0 ? "+" : ""}${
							ownerData.revenue.percentChange
						}%`}
					...
					<StatsCard
						...
						value={formatCurrency(
							ownerData.invoices.outstanding.total,
							currency
						)}
						icon={TrendingUp}
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
					<StatsCard
						...
						icon={GraduationCap}
						trend={`${ownerData.students.change >= 0 ? "+" : ""}${
							ownerData.students.change
						}`}
						description={`${
							Math.abs(ownerData.students.change) === 1 ? "student" : "students"
						} this month`}
					/>
					<StatsCard
					...
					<StatsCard
						...
						icon={Users}
						trend={
							ownerData.teachers.change === 0
								? "No change"
								: `${ownerData.teachers.change > 0 ? "+" : ""}${
										ownerData.teachers.change
								  }`
						}
						description={
							ownerData.teachers.change === 0
								? ""
								: `${
										Math.abs(ownerData.teachers.change) === 1
											? "teacher"
											: "teachers"
								  } this month`
						}
			...
			<div className="space-y-8">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
					<StatsCard
						...
						icon={Calendar}
						trend={
							teacherData.classes.next
								? `Next: ${teacherData.classes.next.time}`
								: "No more classes today"
						}
						description={
							teacherData.classes.next ? teacherData.classes.next.title : ""
						}
					/>
					<StatsCard
						...
						icon={Users}
						trend={`${teacherData.students.change >= 0 ? "+" : ""}${
							teacherData.students.change
						}`}
									...
									>
										<div>
											...
											<p className="text-sm text-gray-500">
												{classItem.location?.name || "Location TBD"} •{" "}
										...
										<div className="text-right">
											<p className="text-brand-primary font-medium">
												...
												{formatClassTime(classItem.end_time)}
											</p>
