				...
				const { data, error } = await supabase
					...
					.select(
						...
						studio:studios!users_studio_id_fkey(
							id, name, address, phone, email, country, currency, timezone, stripe_connect_id, stripe_connect_enabled, stripe_connect_onboarding_complete, uses_platform_payments, bank_account_name, bank_account_last4
						)
					`
					)
					.eq("id", userId)
